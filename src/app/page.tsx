    ...
    <>
      <section className="hero-section">
        ...
        <div className="hero-stats">
          <div><span className="stat-label">DATE</span><strong>16 SEPT</strong><span className="stat-blue">2026</span></div>
      ...
      <section className="section-frame" id="how-it-works" style={{ borderTop: '1px solid var(--color-border-subtle)' }}>
        <div className="section-index">03 <span>/</span> THE BUILD</div>
      ...
      <section className="section-frame final-cta" style={{ borderTop: '1px solid var(--color-border-subtle)' }}>
